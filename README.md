...
- **verificationgatekeeper.bypass.itemskinning** -- Players and groups with this permission bypass the restrictions on the following hooks: *OnItemSkinChange, CanCraft*
...
- **Prevent Item Skinning** -- (true/false) Prevents players from creating skinned items / changing item skins. Hooks: *OnItemSkinChange, CanCraft*
